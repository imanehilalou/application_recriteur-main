    ...
    <main>
      <h2>Rechercher des CV</h2> 
        ...
        <section class="cv">
            <ul id="cvList"> 
                <li class="cvItem"> 
                    ...
                    <p class="domaine" data-category="Thechnologie de l'information">Thechnologie de l'information</p>
                  </div>
                  <div class="champ">
                    <strong id="strong">Fonction :</STRong>
                    <p class="fonction">Achat</p>
                  </div>
                  <div class="champ">
                ...
                <li class="cvItem"> 
                  <img src="per1.webp"> 
                  <h3 >Profil numero : 2</h3>
                  <div class="champ">
                    <strong id="strong">Domaine :</STRong>
                  <p class="domaine">Agriculture</p>
                </div>
                <div class="champ">
                  <strong id="strong">Fonction :</STRong>
                  <p class="fonction">Commercial</p>
                </div>
                <div class="champ">
                  <strong id="strong">Formation :</STRong>
        ...
        ?>
                ...
                <li class="cvItem"> 
                  <img src="per1.webp"> 
                  <h3 >Profil numero : <?php echo $row['id']?></h3>
                  <div class="champ">
                    <strong id="strong">Domaine :</STRong>
                  <p class="domaine"><?php echo $row['domaine']?>
                  </p>
                </div>
                <div class="champ">
                  <strong id="strong">Fonction :</STRong>
                  <p class="fonction"><?php echo $row['fonction']?></p>
                </div>
                <div class="champ">
                  <strong id="strong">Formation :</STRong>
